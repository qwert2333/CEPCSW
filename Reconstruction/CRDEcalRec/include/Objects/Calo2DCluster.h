#ifndef CALO2D_CLUSTER_H
#define CALO2D_CLUSTER_H
...
namespace PandoraPlus {
  ...
  public: 
	...
	void addCluster(const Calo1DCluster* _1dcluster){ m_1dclusters.push_back(_1dcluster);if(_1dcluster->getCluster().at(0)->getSlayer()==0) m_v1dclusters.push_back(_1dcluster); if(_1dcluster->getCluster().at(0)->getSlayer()==1) m_u1dclusters.push_back(_1dcluster);}
