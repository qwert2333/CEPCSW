...
namespace PandoraPlus{
  ...
  public: 
    ...
    //}
	  ...
	  std::vector<const Calo2DCluster*> getBlocks() const { return blockCol; }
    ...
    void addBlock( const Calo2DCluster* _bl ) { blockCol.push_back(_bl); }
	  void setBlocks( std::vector<const Calo2DCluster*> _bls ) { blockCol=_bls; }
  ...
  private: 
    ...
    std::vector<const Track *> trkCol;
	  std::vector<const Calo2DCluster*> blockCol;
