...
public: 
  ...
  StatusCode LongiConeLinking( std::map<int, std::vector<CRDEcalEDM::CRDCaloHitTransShower> >& orderedShower, std::vector<CRDEcalEDM::CRDCaloHit3DCluster>& ClusterCol );
