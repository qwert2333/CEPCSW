...
public: 
  ...
  StatusCode GetLocalMax( const PandoraPlus::Calo2DCluster* m_2dClus, std::vector<const PandoraPlus::Calo1DCluster*>& m_outputU, std::vector<const PandoraPlus::Calo1DCluster*>& m_outputV);
