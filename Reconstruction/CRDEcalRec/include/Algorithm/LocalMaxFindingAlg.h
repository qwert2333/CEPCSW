...
public: 
  ...
  StatusCode GetLocalMax( const PandoraPlus::Calo2DCluster* m_2dClus, std::vector<const PandoraPlus::CaloBarShower*>& m_outputU, std::vector<const PandoraPlus::CaloBarShower*>& m_outputV);
