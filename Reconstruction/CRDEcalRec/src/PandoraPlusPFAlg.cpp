  ...
  for(int it=0; it<m_towers.size(); it++){
    ...
    for(int ic=0; ic<m_NclusX; ic++){
      ...
      for(int is=0; is<m_longicl.getBarShowers().size(); is++){
        m_showerX_x.push_back( m_longicl.getBarShowers()[is].getPos().X() );
        m_showerX_y.push_back( m_longicl.getBarShowers()[is].getPos().Y() );
        m_showerX_z.push_back( m_longicl.getBarShowers()[is].getPos().Z() );
    ...
    for(int ic=0; ic<m_NclusY; ic++){
      ...
      for(int is=0; is<m_longicl.getBarShowers().size(); is++){
        m_showerY_x.push_back( m_longicl.getBarShowers()[is].getPos().X() );
        m_showerY_y.push_back( m_longicl.getBarShowers()[is].getPos().Y() );
        m_showerY_z.push_back( m_longicl.getBarShowers()[is].getPos().Z() );
