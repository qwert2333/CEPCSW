...
StatusCode EnergySplittingAlg::LongiClusterLinking( std::vector<PandoraPlus::CaloBlock*>& m_blocks, 
...
for(int icl=0; icl<m_cluscol.size(); icl++) cout<<m_cluscol[icl]->getBarShowers().size()<<'\t';
cout<<endl;
