...
public:
  CaloBar(unsigned long long _cellID, int _system, int _module, int _crystal, dd4hep::Position _pos, double _Q1, double _Q2, double _T1, double _T2)
  : cellID(_cellID), system(_system), module(_module), crystal(_crystal), position(_pos), Q1(_Q1), Q2(_Q2), T1(_T1), T2(_T2) {}; 
  CaloBar() {};
