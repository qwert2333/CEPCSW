...
protected:
  ...
  int m_Ncluster;
  FloatVec m_clus_phi, m_clus_Z, m_clus_E, m_clus_phi_start,m_clus_chi2,m_clus_alpha,m_clus_beta,m_MCendpoint_x,m_MCendpoint_y,m_MCendpoint_z,m_MCmomentum_x,m_MCmomentum_y,m_MCmomentum_z;
  IntVec m_clus_Nbars;
  ...
  mutable Gaudi::Property<std::string> _readoutMC{this, "ReadOutName", "MCParticleG4", "Readout name"};//add
  mutable Gaudi::Property<std::string> _filename{this, "OutFileName", "testout.root", "Output file name"};
//  mutable Gaudi::Property<std::string> _filenameMC{this, "OutFileName", "testout.root", "Output file name"};//add
