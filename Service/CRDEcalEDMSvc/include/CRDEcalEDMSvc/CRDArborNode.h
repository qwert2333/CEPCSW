...
namespace CRDEcalEDM{
  ...
  public:
    ...
    CRDArborNode(){};
    CRDArborNode( CRDEcalEDM::CRDCaloBarShower _shower ) ;  
    ~CRDArborNode() { Clear(); }
    ...
    void Clear() {
      pos.SetXYZ(0.,0.,0.); Rref.SetXYZ(0.,0.,0.); En=0; barShower.Clear(); Type=0;
    ...
    int GetDlayer() const { return barShower.getDlayer();  }
    int GetType() const { return Type; }
    CRDEcalEDM::CRDCaloBarShower GetOriginShower() const { return barShower; }
    ...
    void SetOriginBarShower( CRDEcalEDM::CRDCaloBarShower& _sh ) { barShower=_sh; }
  ...
  private: 
    ...
    int Type; //0: isolate node. 
              ...
              //4: root node. 
              //5: star root node. 
    CRDEcalEDM::CRDCaloBarShower barShower;  
