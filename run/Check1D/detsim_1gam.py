...
gun.PositionYs = [0.] # mm
gun.PositionZs = [0.] # mm
gun.EnergyMins = [30.] # GeV
gun.EnergyMaxs = [30.] # GeV
...
#gun.PositionZs = [-10, 20] # mm
#gun.EnergyMins = [0.5, 0.5] # GeV
#gun.EnergyMaxs = [0.5, 0.5] # GeV
...
out.filename = "PhotonShower_30GeV.root"
